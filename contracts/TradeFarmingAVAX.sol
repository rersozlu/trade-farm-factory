...
contract TradeFarmingAVAX is ITradeFarmingAVAX, Ownable {
    ...
    function claimAllRewards() external virtual override {
        ...
        for (uint256 i = 0; i < len; i++) {
            require(
                ...
                "[claimAllRewards] Unsuccessfull set operation"
            );
        }
    ...
    function swapExactAVAXForTokens(
        ...
        if (
            ...
            require(
                ...
                "[swapExactAVAXForTokens] Unsuccessfull set operation"
            );
    ...
    function swapAVAXForExactTokens(
        ...
        if (
            ...
            require(
                tradedDays[msg.sender].add(calcDay()),
                "[swapAVAXForExactTokens] Unsuccessfull set operation"
            );
    ...
    function swapExactTokensForAVAX(
        ...
        if (
            ...
            require(
                tradedDays[msg.sender].add(calcDay()),
                "[swapExactTokensForAVAX] Unsuccessfull set operation"
            );
    ...
    function swapTokensForExactAVAX(
        ...
        if (
            ...
            require(
                tradedDays[msg.sender].add(calcDay()),
                "[swapTokensForExactAVAX] Unsuccessfull set operation"
            );
